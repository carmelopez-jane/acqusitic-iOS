...
@implementation FormItemSimpletext

@synthesize contentView, lblLabel, tfValue;
...
-(void)internalInit {
    ...
    if (bundle) {
        [bundle loadNibNamed:@"FormItemSimpletext" owner:self options:nil];
        if (self.contentView) {
