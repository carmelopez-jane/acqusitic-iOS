...
@objc public class UICustomCollectionViewLayout: UICollectionViewLayout {
    
    @objc public var delegate: CustomLayoutDelegate!
    private var showHeader = false
    private var showFooter = false
    
    @objc public var numberOfColumns = 2
    @objc public var cellPadding: CGFloat = 5.0
